...
export function CrisisModal({
  ...
  // Issue 4: auto-close modal after successful edit
  useEffect(() => {
    ...
    <div className="fixed inset-0 bg-black/40 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="relative bg-card rounded-2xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto border border-border">
        ...
        <form action={formAction} className="p-6 space-y-4">
          ...
          {/* Issue 5: hidden inputs for ALL optional features */}
          ...
          <div className="flex gap-3 pt-2">
            ...
            >
              {/* Issue 4: correct pending label for each mode */}
