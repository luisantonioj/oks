    ...
    <div className="min-h-screen flex bg-background">
          ...
          <div className="w-full max-w-md">
            ...
            <div className="flex items-start gap-3 bg-blue-500/10 border border-blue-500/20 rounded-xl p-3.5 mb-6">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                This portal is for authorized office staff only. Your account must be created by the system administrator.
              </p>
            </div>
      ...
      <div className="hidden lg:flex flex-1 bg-card border-l border-border items-center justify-center p-8 xl:p-16 relative overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-sm">
          <div className="bg-background rounded-2xl border border-border shadow-lg p-5 mb-5">
